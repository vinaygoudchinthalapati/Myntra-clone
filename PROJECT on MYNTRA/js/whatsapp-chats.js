        ...
        if(settings.selector != ''){
            ...
            if(element !=null){
                var chatBox = '<div class="ayoan_whatsapp_chatbox_container">' +
                    ...
                    '<img class="header-icon" src="images/WhatsApp.svg.WEBP"></div><div class="col col-2">' +
                    ...
                    '<img class="icon" src="images/WhatsApp.svg.WEBP"></button></div></div>' +
